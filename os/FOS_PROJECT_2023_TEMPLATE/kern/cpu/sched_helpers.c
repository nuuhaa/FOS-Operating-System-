...
{	cprintf("kernel side env_set_nice value has been called!\n");
...
int env_get_recent_cpu(struct Env* e)
{
	...
	fixed_point_t fractional_result=fix_scale(e->recent_cpu,100);
	int integer_result=fix_round(fractional_result);
...
int get_load_average()
{
	...
	//Comment the following line
	//panic("Not implemented yet");
	fixed_point_t fractional_result=fix_scale(load_avg,100);
		int integer_result=fix_round(fractional_result);
		return integer_result;
}
/********* for BSD Priority Scheduler *************/
